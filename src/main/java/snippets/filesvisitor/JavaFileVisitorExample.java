...
public class JavaFileVisitorExample implements FileVisitor {
    ...
    public FileVisitResult visitFile(Object file, BasicFileAttributes attrs) throws IOException {
        int c= fileCount.incrementAndGet();
        if(c % 10000 == 0)
    ...
    public static void main(String[] args) throws IOException {
        ...
        Files.walkFileTree(Paths.get("/Users/jfreire"), new JavaFileVisitorExample());
        System.out.println("Time taken wile fileVisitor: " + Duration.between(start, Instant.now()));
        //
        start = Instant.now();
        new StreamsFileCounter().walkStreamsWay("/Users/jfreire");
        System.out.println("Time taken streams: " + Duration.between(start, Instant.now()));
        //
        start = Instant.now();
        new FileCounterViaExecutorService().walkESWay("/Users/jfreire");
    ...
    {
        public void walkStreamsWay(String s) {
